<div class="row mb-4">
    <div class="col-md-12">
        <h1>
            <i class="bi bi-pencil"></i> Editar Platillo
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?= \App\Core\View::url('/menu/' . $restaurant['id'] . '/update/' . $item['id']) ?>">
                    <?= \App\Core\Csrf::input() ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select <?= isset($errors['category_id']) ? 'is-invalid' : '' ?>" id="category_id" name="category_id" required>
                            ...
                            <?php foreach ($categories as $category): ?>
                                <option value="<?= $category['id'] ?>" <?= ($_POST['category_id'] ?? $item['category_id']) == $category['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        ><?= $_POST['description'] ?? $item['description'] ?></textarea>
                    </div>
